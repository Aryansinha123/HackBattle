...
export default function Navbar() {
  ...
  return (
    <header className="w-full bg-gradient-to-r from-[#0f172a] via-[#064e3b] to-[#0ea5e9] text-white">
      <nav className="mx-auto max-w-6xl px-4 sm:px-6 py-4 flex items-center gap-4">
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <Link
            href="/login"
            className="hidden sm:inline-flex items-center justify-center rounded-md border border-white/20 px-3 py-2 text-sm hover:bg-white/10"
          >
            Login
          </Link>
          ...
          className="inline-flex items-center justify-center h-10 w-10 rounded-md border border-white/20 hover:bg-white/10 transition-colors"
        ...
        {isOpen && (
          <>
            ...
            <motion.aside
              key="panel"
              id="mobile-menu"
              className="fixed right-0 top-0 h-full w-[85%] sm:w-[360px] max-w-full bg-[#0f172a] text-white border-l border-white/10 shadow-xl flex flex-col"
              initial={{ x: "100%" }}
              animate={{ x: 0 }}
              exit={{ x: "100%" }}
            ...
            >
              <div className="px-5 py-4 border-b border-white/10 flex items-center justify-between">
                ...
                <button
                  ...
                  className="h-9 w-9 rounded-md border border-white/20 hover:bg-white/10"
                  onClick={() => setIsOpen(false)}
                >
                  ✕
                </button>
              ...
              <div className="p-5 border-b border-white/10">
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-md border border-white/20 bg-transparent px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-cyan-400/40"
                  />
                  <Link
                    href="/internships"
                    className="mt-3 inline-flex items-center justify-center rounded-md border border-white/20 px-3 py-2 text-sm hover:bg-white/10"
                    onClick={() => setIsOpen(false)}
                  >
                    Go to Search
                  </Link>
